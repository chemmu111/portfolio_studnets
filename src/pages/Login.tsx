...
const Login: React.FC = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      // Simulate email sending (in a real app, this would call your backend)
      await new Promise(resolve => setTimeout(resolve, 2000));
      
      // For demo purposes, show the reset credentials
      if (resetEmail === 'admin@techschool.com') {
        toast.success('Password reset email sent! Check your inbox.');
        // In a real app, you would send an actual email here
        setTimeout(() => {
          toast.success('Demo: Your new password is "admin@123"', { duration: 8000 });
        }, 1000);
      } else {
        ...
        {!showForgotPassword ? (
          ...
          <>
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-gray-700 dark:text-secondary">Enter your email to receive reset instructions</p>
            </div>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-secondary" size={16} />
                  <input
                    type="email"
                    value={resetEmail}
